    ...
    <div class="container mx-auto px-4 z-10">
      <div class="max-w-2xl">
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight animate-slide-up">
          Authentic Middle Eastern <span class="text-primary-400">Flavors</span> & <span class="text-secondary-400">Traditions</span>
        </h1>
        <p class="text-lg md:text-xl mb-8 text-neutral-200 animate-slide-up" style="animation-delay: 0.2s">
          Discover the finest selection of fresh meats, traditional bakery items, and authentic Arab groceries at Al Karmel Meat & Bakery.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 animate-slide-up" style="animation-delay: 0.4s">
          ...
          <Link to="/contact">
            <button class="btn bg-white text-primary-700 hover:bg-neutral-100">Contact Us</button>
          </Link>
        </div>
      </div>
    </div>
      ...
      <div class="flex flex-col lg:flex-row items-center gap-12">
        <div class="lg:w-1/2">
          <div class="relative">
            ...
            <div class="absolute -bottom-6 -right-6 hidden md:block">
              <img 
                src="https://images.pexels.com/photos/6249381/pexels-photo-6249381.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" 
                alt="Fresh Bread" 
        ...
        <div class="lg:w-1/2">
          ...
          <p class="mb-6 text-neutral-700">
            Welcome to Al Karmel Meat & Bakery, your trusted source for authentic Middle Eastern cuisine and groceries. For over 15 years, we have been providing our community with the freshest ingredients and traditional flavors from the Arab world.
          </p>
          <p class="mb-6 text-neutral-700">
            Our commitment to quality means we source only the finest halal meats, bake our bread daily using traditional recipes, and import authentic products directly from the Middle East.
          </p>
          <Link to="/about">
